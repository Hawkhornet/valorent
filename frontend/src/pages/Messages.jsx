  ...
  return (
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      <div className='py-10'>
        ...
        {loading ? (
          <div className='text-center text-gray-500 py-20'>Loading chats...</div>
                 ...
                 key={chat.id} className='w-full p-4 hover:bg-gray-50 transition-colors text-left'>
                  <div className='flex items-center space-x-4'>
                    <div className='flex-shrink-0'>
                      <img src={chatUser?.image} alt={chatUser?.name || 'User'} className='w-10 h-10 rounded-full object-cover' />
                    </div>
