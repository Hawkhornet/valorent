        ...
        <>
            <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
                ...
                <h1 className="text-4xl md:text-6xl font-semibold max-w-lg md:max-w-2xl text-center mt-4 leading-tight md:leading-tight">
                    Rent out <span className="relative bg-gradient-to-r from-red-700 to-[#C24444] bg-clip-text text-transparent">
                        your vehicle.
                        <div className="z-10 absolute bottom-0 left-0 w-full scale-110" >
                            <img src='https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gradient_arc.svg' alt="gradient" />
                        </div>
                    </span> <span className='relative bg-gradient-to-r from-[#C24444] to-red-600 bg-clip-text text-transparent'>Rent</span> a vehicle.
                </h1>

                <p className="max-w-xl text-center text-base my-7">List your vehicle to rent or browse, compare and book vehicles based on your preferences.
                    All in one place - safe and hassle free</p>
                ...
                <form onSubmit={onSubmitHandler} className='w-full flex justify-center group'>
                    <label className='border border-gray-400 rounded-md p-1 flex items-center w-full max-w-md'>
                        <input onChange={e => setInput(e.target.value)} value={input} type="text" placeholder='search for a vehicle' className='pl-2 flex-1 outline-none' />
                        <button className='bg-red-600 text-white p-3 px-6 rounded-md cursor-pointer'> Search </button>
                    </label>
                </form>
            </div>
        </>
